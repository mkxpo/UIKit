...
namespace Core {
    ...
    public static class IEnumerableExtensions {
        public static IBindingList ToBindingList(this IEnumerable items, Type itemType) {
            var castMethod = typeof(Enumerable).GetMethod("Cast").MakeGenericMethod(itemType);
            var bindingListType = typeof(SortableBindingList<>).MakeGenericType(itemType);
            var castedEnumerable = castMethod.Invoke(null, new object[] { items });
            return Activator.CreateInstance(bindingListType, castedEnumerable) as IBindingList;
        }
        public static IBindingList ToBindingList<T>(this IEnumerable<T> items) {
            return ToBindingList(items, typeof(T));
        }
    }
